	...
	void hashlittle2(
		...
		if (HASH_LITTLE_ENDIAN && ((u.i & 0x3) == 0)) {
			...
			case 10: c += k[4];
				...
				a += k[0] + (((uint32_t)k[1]) << 16);
				break;
			case 9: c += k8[8]; [[fallthrough]];                     /* fall through */
			case 8: b += k[2] + (((uint32_t)k[3]) << 16);
				a += k[0] + (((uint32_t)k[1]) << 16);
				break;
			case 7: b += ((uint32_t)k8[6]) << 16; [[fallthrough]];    /* fall through */
			case 6: b += k[2];
				a += k[0] + (((uint32_t)k[1]) << 16);
				break;
			case 5: b += k8[4]; [[fallthrough]];                      /* fall through */
			case 4: a += k[0] + (((uint32_t)k[1]) << 16);
				break;
			case 3: a += ((uint32_t)k8[2]) << 16; [[fallthrough]];      /* fall through */
			case 2: a += k[0];
				break;
			case 1: a += k8[0];
				break;
